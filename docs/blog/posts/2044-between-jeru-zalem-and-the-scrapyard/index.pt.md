---
title: "2044: Entre Jerú, Zalem e a Cidade da Sucata"
description: "A Inteligência Artificial vai nos libertar — ou transformar pessoas em resíduos do próprio progresso?"
date: 2026-05-05
...
A McKinsey estima que os gastos globais com data centers podem chegar a cerca de **US$ 7 trilhões até 2030**, impulsionados pela corrida para escalar IA e infraestrutura computacional. ([mckinsey.com](https://www.mckinsey.com/industries/technology-media-and-telecommunications/our-insights/the-7-trillion-dollar-data-center-build-out-how-industrials-can-capture-their-share))
...
O FMI estima que cerca de **40% dos empregos no mundo** estão expostos à IA; em economias avançadas, esse número pode chegar a **60%**, com parte dos empregos sendo complementada pela IA e outra parte enfrentando redução de demanda, salários ou contratação. ([imf.org](https://www.imf.org/en/blogs/articles/2024/01/14/ai-will-transform-the-global-economy-lets-make-sure-it-benefits-humanity))

A Goldman Sachs também estimou que a IA generativa pode expor o equivalente a **300 milhões de empregos em tempo integral** à automação. Isso não significa que 300 milhões de pessoas necessariamente perderão seus empregos, mas que muitas tarefas realizadas por humanos podem ser parcialmente automatizadas. ([goldmansachs.com](https://www.goldmansachs.com/insights/articles/how-will-ai-affect-the-us-labor-market))
...
Em *Battle Angel Alita*, de Yukito Kishiro, encontramos um mundo marcado por desigualdade extrema, corpos modificados, ciborgues, biotecnologia avançada, manipulação da identidade, controle social e tensão entre humanidade e tecnologia. A obra original é um mangá cyberpunk publicado nos anos 1990, com sequências como *Battle Angel Alita: Last Order* e *Battle Angel Alita: Mars Chronicle*. ([wikipedia.org](https://en.wikipedia.org/wiki/Battle_Angel_Alita))

Na obra, a hierarquia entre a Cidade da Sucata, Zalem e Jerú não é apenas geográfica. Ela representa diferentes camadas de acesso, poder e controle tecnológico. Em traduções antigas, Zalem também aparece como Tiphares, e Jerú aparece como Ketheres. ([wikipedia.org](https://en.wikipedia.org/wiki/Battle_Angel_Alita))
...
**Melchizedek** pode ser entendido como uma inteligência computacional central, ligada à governança, à infraestrutura e ao controle de uma sociedade altamente tecnológica. Na obra, Melchizedek é descrito como um supercomputador quântico ligado a Ketheres/Jerú e tem papel importante em *Last Order*. ([battleangel.fandom.com](https://battleangel.fandom.com/wiki/Melchizedek))
...
**Unanimous** amplia ainda mais essa questão. Na obra, Unanimous é descrito como um sistema de ordem pública usado pelos residentes de Ketheres/Jerú, oficialmente associado ao acesso a Melchizedek para informação. ([battleangel.fandom.com](https://battleangel.fandom.com/wiki/Unanimous))
...
Já a **Matuzalenização** traz uma dimensão ainda mais pesada: a busca pela extensão radical da vida, preservação da consciência, manipulação biológica e superação dos limites humanos. Na obra, a Methuselyzation/Matuzalenização é descrita como um processo que interrompe o envelhecimento por meio de nanomáquinas pessoais instaladas no corpo. ([battleangel.fandom.com](https://battleangel.fandom.com/wiki/Methuselyzation))
...
4. **Verificar fontes e evidências.**  
...
6. **Produzir sua própria síntese.**  
